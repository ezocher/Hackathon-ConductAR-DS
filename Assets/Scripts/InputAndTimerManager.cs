...
public class InputAndTimerManager : MonoBehaviour
{
    ...
    public float playerMoveMetersPerSecond = 2.0f;
    ...
    readonly KeyCode[] addRemovePlayerKeys = { KeyCode.Alpha1, KeyCode.Alpha2, KeyCode.Alpha3, KeyCode.Alpha4, KeyCode.Alpha5, KeyCode.Alpha6, KeyCode.Alpha7, KeyCode.Alpha8, KeyCode.Alpha9 };
    readonly KeyCode[] playerStepBackKeys = { KeyCode.Q, KeyCode.W, KeyCode.E, KeyCode.R, KeyCode.T, KeyCode.Y, KeyCode.U, KeyCode.I, KeyCode.O };
    readonly KeyCode[] playerStepForwardKeys = { KeyCode.A, KeyCode.S, KeyCode.D, KeyCode.F, KeyCode.G, KeyCode.H, KeyCode.J, KeyCode.K, KeyCode.L };

    readonly KeyCode[] togglePlayPauseKeys = { KeyCode.Space, KeyCode.Tab, KeyCode.P };

    readonly KeyCode[] quitKeys = { KeyCode.Escape, KeyCode.Delete, KeyCode.Backspace, KeyCode.End };
        ...
        for (int keyIndex = 0; keyIndex < numberOfLanes; keyIndex++)
        {
            ...
            if (playerActive[keyIndex])
            {
                ...
                if (Input.GetKey(playerStepBackKeys[keyIndex]))
                    newBucketNumber = lanesManager.MovePlayer(keyIndex + 1, playerMoveMetersPerSecond);
